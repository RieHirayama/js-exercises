...
function saveTodos(todos) {
  try {
    ...
    // sessionStorage が使えない場合は、メモリキャッシュだけを更新
    console.log("sessionStorage が使えない場合は、メモリキャッシュを使用");
  }
...
function loadTodos() {
  try {
    ...
    // sessionStorage が使えない場合は、メモリキャッシュを使用
    console.log("sessionStorage が使えない場合は、メモリキャッシュを使用");
...
// ページが開かれた時に、sessionStorage からToDoリストを読み込んで表示する
